<template>
  <a-switch v-model:checked="checked" @change="toggleDark">
    <template #checkedChildren>
      <icon class="text-[var(--color-primary)]">
        <template #component>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 28 24">
    ...
    <template #unCheckedChildren>
      <icon class="text-[var(--color-primary)]">
        <template #component>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 14 28">
            <path fill="currentColor"
...
const checked = computed(() => isDark.value)
</script>
